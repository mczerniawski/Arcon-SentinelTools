function Convert-DetectionRuleFromYamlToArm {
    param (
...
"@
    ...
    $alertRule.queryFrequency = $(Test-ISO8601Format $yaml.queryFrequency.ToUpper())
    $alertRule.queryPeriod = $(Test-ISO8601Format $yaml.queryPeriod.ToUpper())
